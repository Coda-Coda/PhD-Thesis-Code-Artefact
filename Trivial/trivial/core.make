...
core.make.conf: _CoqProject
	/nix/store/m8ab7rmaqa0lsk0wcw9jbb0m6kyjy91p-coq-8.14.1/bin/coq_makefile -arg -quiet -f _CoqProject -o core.make

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include core.make.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in core.make.local once and for all.
...
# put in core.make.local double colon rules accordingly.
...
#
# There rules can be extended in core.make.local
...
# extension points and core.make.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in core.make.local or include core.make.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in core.make.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create core.make.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include core.make.local-late
